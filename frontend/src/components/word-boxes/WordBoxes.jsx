...
const WordBoxes = () => {
  const { selectedLang, boxesData, serchEntered } = useData();
    ...
    <div className="w-full md:w-[53%] flex justify-start px-[1rem] mx-auto z-50">
      <div className="flex flex-col gap-[1rem] justify-center items-start w-full h-full mt-[1.75rem] md:ml-[-4.5rem] word-boxes z-50">
        <SecondaryBox
          ...
          numbers_list={
            lang === "ir"
              ? boxesData?.kabir.list_kabir_number
              : boxesData?.hebrew.list_hebrew_numbers
          }
          type="کبیر"
          ...
          number={
            lang === "ir"
              ? boxesData?.kabir.kabir_number
              : boxesData?.hebrew.hebrew_number
          }
        ...
        <SecondaryBox
          ...
          numbers_list={
            lang === "ir"
              ? boxesData?.saghit.list_saghit_number
              : boxesData?.english.list_english_numbers
          }
          type="سقیط"
          title={
          ...
          number={
            lang === "ir"
              ? boxesData?.saghit.saghit_number
              : boxesData?.english.english_number
          }
        ...
        <SecondaryBox
          ...
          numbers_list={
            lang === "ir"
              ? boxesData?.vasit.list_vasit_number
              : boxesData?.simple.list_simple_numbers
          }
          type="کبیر"
          ...
          number={
            lang === "ir"
              ? boxesData?.vasit.vasit_number
              : boxesData?.simple.simple_numbers
          }
